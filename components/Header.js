...
return(
    ...
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10 ">
        ...
        <div className="flex space-x-4 items-center justify-end text-gray-500">
            ...
            <GlobeAltIcon className="animate-spin animate-spin h-6 cursor-pointer" />
    ...
    {searchInput && (
            <div className="flex  flex-col mx-auto">
                    ...
                    <div className="flex items-center border-b mb-4">
                        ...
                        <input value={noOfGuests} onChange={(e)=> setnoOfGuests(e.target.value)} className="w-12 pl-2 text-lg outline-none text-red-400" type="number"  />
                    </div>
                    <div className="flex ">
